...
async def next_page(bot, query):
    try:
        ...
        btn.insert(0, [InlineKeyboardButton("• DesiSinBot •", url=f"https://t.me/DesiSinXBot")])
        btn.insert(1, [
...
async def season_search(client: Client, query: CallbackQuery):
    ...
    btn.insert(0, [
        InlineKeyboardButton("• DesiSinXBot •", url=f"https://t.me/DesiSinXBot"),
        InlineKeyboardButton("• Movies •", url=f"https://t.me/aksearch")
    ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "close_data":
        ...
        buttons = [[
            InlineKeyboardButton('ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 📜', url='https://t.me/DesiSinXBot'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset and total_results >= int(MAX_BTN):
        ...
        btn.insert(0, [InlineKeyboardButton("• Aᴅᴜʟᴛ •", url=f"https://t.me/DesiSinXBot")])
        btn.insert(1, [
            InlineKeyboardButton("• ǫᴜᴀʟɪᴛʏ •", callback_data=f"qualities#{key}#{offset}#{req}"),
            InlineKeyboardButton("• Movies •", url=f"https://t.me/aksearch")
        ])
