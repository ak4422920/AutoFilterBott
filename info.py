...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8371607189').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/AkMovieVerse")
...
TUTORIAL2 = environ.get("TUTORIAL2", "https://t.me/how_to_open_link_ak/17")
TUTORIAL3 = environ.get("TUTORIAL3", "https://t.me/how_to_open_link_ak/25")
...
SHORTENER_API3 = environ.get("SHORTENER_API3", "ef0b2771c0566718523c43928b4119fdfff25c8a")
...
auth_channels = environ.get("AUTH_CHANNELS", "-1002331917822")# Channels for force sub (make sure bot is admin)
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002750225419 -1001769437975 -1002990775643 -1002862562008').split()] # Auto Index Channel
